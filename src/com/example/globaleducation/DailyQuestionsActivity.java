/* Alarm source code adapted from the following site: 
...
public class DailyQuestionsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText("Welcome back, " + childUsername
				+ "\n\nClick the button below" + " try your daily question!");
		...
		// This is the code to notify the child once every 24 hours when a
		// question is ready
	...
	public void setAlarm() {
		...
		alarmIntent = new Intent(DailyQuestionsActivity.this,
				AlarmReceiver.class);
		pendingIntent = PendingIntent.getBroadcast(DailyQuestionsActivity.this,
				0, alarmIntent, 0);
	...
	private class QuestionGetTask extends AsyncTask<String, Void, List<String>> {
		...
		protected List<String> doInBackground(String... params) {
			...
			String URL = "http://cmsc436.afh.co/php/getquestion.php?username="
					+ params[0];
		...
		protected void onPostExecute(List<String> result) {
			...
			Intent i = new Intent(DailyQuestionsActivity.this,
